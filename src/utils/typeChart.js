const TYPE_CHART = {
    ...
    Flying: { Electric: 2, Ice: 2, Rock: 2, Fighting: 0.5, Grass: 0.5, Bug: 0.5, Ground: 0 },
...
export const getEffectiveness = (targetTypes) => {
    const effectiveness = {};
    Object.keys(TYPE_CHART).forEach(type => effectiveness[type] = 1);

    targetTypes.forEach(targetType => {
        const interactions = TYPE_CHART[targetType];
        if (interactions) {
            Object.entries(interactions).forEach(([attackerType, multiplier]) => {
